...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($connect, "INSERT INTO `order`(name, number, address, email, total_products, total_price) VALUES('$name','$number','$address', '$email','$total_product','$price_total')") or die('query failed');
   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='BananaBro.html' class='btn'>HOME</a>
